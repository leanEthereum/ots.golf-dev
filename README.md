...
| Upper bound · hinted RISC-V cycles | `formal/Submissions/UpperRiscvHint/` | `verify.py upper-riscv-hint` |
...
| [`formal/OptimalOTS/`](formal/OptimalOTS/) | the contract: [`Model.lean`](formal/OptimalOTS/Model.lean), [`Dag.lean`](formal/OptimalOTS/Dag.lean), [`WholeWords.lean`](formal/OptimalOTS/WholeWords.lean), [`OracleAlgorithm.lean`](formal/OptimalOTS/OracleAlgorithm.lean), [`Riscv.lean`](formal/OptimalOTS/Riscv.lean), [`RiscvMachine.lean`](formal/OptimalOTS/RiscvMachine.lean), [`RiscvHint.lean`](formal/OptimalOTS/RiscvHint.lean), [`LeanIsa.lean`](formal/OptimalOTS/LeanIsa.lean), [`LeanIsaMachine.lean`](formal/OptimalOTS/LeanIsaMachine.lean), and the challenge stubs in `Challenge/` |
